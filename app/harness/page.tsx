    ...
    <>
      ...
      <main className="pt-32 pb-24 px-6 relative z-10 max-w-4xl mx-auto space-y-16">
        ...
        <div className="py-8 max-w-2xl mx-auto text-center">
          <h3 className="text-xl font-semibold text-[#f5f5f7] mb-4">Sprocket 자율 생성 산출물 (예시)</h3>
          <p className="text-[#86868b] text-sm mb-6">듀얼 Type-C 커스텀 Pico 2W 폼팩터 자동 렌더링 결과</p>
          <div className="relative rounded-[24px] overflow-hidden border border-white/[0.08] shadow-2xl">
            <img 
              src="/pico_2w_custom_pcb.jpg" 
              alt="Pico 2W Custom PCB generated by Sprocket" 
