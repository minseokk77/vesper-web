...
export default function DSPPage() {
  const [downloadUrl, setDownloadUrl] = useState("https://github.com/minseokk77/vesper-dsp/releases/latest");
    ...
    <>
      ...
      <main className="pt-32 pb-24 px-6 relative z-10 max-w-4xl mx-auto space-y-16">
        <div className="text-center space-y-4">
          <h1 className="text-5xl md:text-7xl font-semibold tracking-tighter text-[#f5f5f7]">Vesper DSP</h1>
          <p className="text-xl text-[#86868b] tracking-tight">헤드폰 및 스피커 보정 시스템</p>
        </div>
        ...
        <div className="text-lg md:text-xl text-[#86868b] font-medium leading-relaxed text-center max-w-3xl mx-auto tracking-tight">
          시스템 전역에서 작동하는 고정밀 오디오 보정 도구.
          당신의 장비가 가진 본연의 소리를 정확하게 이끌어냅니다.
        </div>
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <span className="text-blue-400 font-semibold">{entry.version}</span>
