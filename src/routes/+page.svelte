...
<section class="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
  ...
  <div class="relative z-10 space-y-6 max-w-4xl">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
      <a href="{base}/dsp" class="px-8 py-3.5 rounded-full bg-[#f5f5f7] text-black font-semibold text-[15px] hover:scale-105 active:scale-95 transition-transform duration-300 ease-out">
        {i18n.t.hero.btnDsp}
      </a>
      <a href="{base}/woofer" class="px-8 py-3.5 rounded-full bg-white/[0.08] text-white font-semibold text-[15px] hover:bg-white/[0.12] hover:scale-105 active:scale-95 transition-all duration-300 ease-out border border-white/5">
        {i18n.t.hero.btnWoofer}
      </a>
      <a href="{base}/harness" class="px-8 py-3.5 rounded-full bg-white/[0.08] text-white font-semibold text-[15px] hover:bg-white/[0.12] hover:scale-105 active:scale-95 transition-all duration-300 ease-out border border-white/5">
        {i18n.t.hero.btnHarness}
      </a>
    </div>
  </div>
</section>
...
<section class="py-24 px-6 relative z-10">
  <div class="max-w-7xl mx-auto grid lg:grid-cols-3 md:grid-cols-2 gap-6">
    <!-- DSP Card -->
    <a href="{base}/dsp" class="group relative rounded-[32px] bg-white/[0.02] border border-white/[0.12] shadow-[inset_0_1px_2px_rgba(255,255,255,0.1),0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-[60px] p-10 overflow-hidden hover:scale-[1.02] transition-all duration-700 ease-out block hover:bg-white/[0.04]">
      <div class="absolute inset-0 bg-gradient-to-br from-indigo-500/[0.08] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
    ...
    <!-- Woofer Card -->
    <a href="{base}/woofer" class="group relative rounded-[32px] bg-white/[0.02] border border-white/[0.12] shadow-[inset_0_1px_2px_rgba(255,255,255,0.1),0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-[60px] p-10 overflow-hidden hover:scale-[1.02] transition-all duration-700 ease-out block hover:bg-white/[0.04]">
      <div class="absolute inset-0 bg-gradient-to-br from-violet-500/[0.08] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
      <div class="relative z-10 flex flex-col h-full">
    ...
    <!-- Harness Card -->
    <a href="{base}/harness" class="group relative rounded-[32px] bg-white/[0.02] border border-white/[0.12] shadow-[inset_0_1px_2px_rgba(255,255,255,0.1),0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-[60px] p-10 overflow-hidden hover:scale-[1.02] transition-all duration-700 ease-out block hover:bg-white/[0.04]">
      <div class="absolute inset-0 bg-gradient-to-br from-emerald-500/[0.08] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
      <div class="relative z-10 flex flex-col h-full">
        <div class="w-10 h-10 rounded-2xl bg-emerald-500/20 flex items-center justify-center mb-6">
          <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/></svg>
        </div>
        <h2 class="text-3xl font-semibold tracking-tight text-[#f5f5f7] mb-3">{i18n.t.home.harnessTitle}</h2>
        <p class="text-[#86868b] leading-relaxed font-medium mb-10 text-[17px] tracking-tight group-hover:text-white/80 transition-colors">
          {i18n.t.home.harnessDesc}
        </p>
        <ul class="space-y-4 mt-auto">
          {#each i18n.t.home.harnessFeatures as feature}
            <li class="flex items-center gap-3 text-[15px] font-medium text-[#f5f5f7]/90"><span class="text-emerald-400">→</span> {feature}</li>
          {/each}
        </ul>
      </div>
    </a>
