export const ko = {
  ...
  hero: {
    ...
    title1: 'The Ultimate',
    title2: 'Ecosystem.',
    subtitle: '스튜디오급 오디오 처리부터 자율 주행 AI 코딩 오케스트레이션까지, 데스크톱의 한계를 뛰어넘으세요.',
    btnDsp: 'DSP 알아보기',
    btnWoofer: 'Woofer 알아보기',
    btnHarness: 'Harness 알아보기'
  },
  harnessDetail: {
    title: '자율 주행 AI 코딩 오케스트레이터',
    intro: 'Vesper Harness는 단순한 명령어 파이프라인이 아닙니다. Aider, SWE-agent, Hermes 등 흩어진 강력한 AI 도구들을 하나로 묶어 완벽한 5단계(분석-보안스캔-계획-실행-검증) 자율 코딩을 지휘합니다.',
    box1Title: '몰입형 TUI 대시보드',
    box1Desc: '백그라운드에서 돌아가는 여러 AI 에이전트들의 실시간 통신 로그와 현재 진행 상태를 터미널 상의 3분할 UI로 화려하게 모니터링할 수 있습니다.',
    box2Title: '지능형 오류 자율 복구',
    box2Desc: 'Playwright 기반의 자율 테스트 중 에러가 발생하면 멈추지 않고, 에러 로그를 분석하여 수정 지침을 생성한 뒤 다시 코딩 단계로 지능형 롤백을 수행합니다.',
    downloadBtn: 'NPM (PNPM) 글로벌 설치 안내',
    sysReqTitle: '시스템 요구사항',
    changelogTitle: '최근 변경사항',
    changelogEmpty: '변경사항을 불러오는 중...',
    totalDownloads: '누적 설치 수'
  },
  home: {
    dspTitle: 'Vesper DSP',
    ...
    harnessDesc: 'Aider, SWE-agent, Hermes 등 다중 AI 에이전트를 통합하는 5-Stage 자율 코딩 엔진. 컨텍스트 분석부터 검증까지 완벽한 파이프라인을 조율합니다.',
    harnessFeatures: ['5단계 자율 에이전트 파이프라인', '동적 스킬 주입 및 자동 룰 맵핑', '터미널 기반 몰입형 UI'],
    faqTitle: '자주 묻는 질문',
    faq: [
