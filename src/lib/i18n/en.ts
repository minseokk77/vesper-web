export const en = {
  ...
  hero: {
    badge: 'Available for Windows & CLI',
    title1: 'The Ultimate',
    title2: 'Ecosystem.',
    subtitle: 'Experience studio-grade audio processing and autonomous AI coding orchestration, pushing the limits of your desktop.',
    btnDsp: 'Explore DSP',
    btnWoofer: 'Explore Woofer',
    btnHarness: 'Explore Harness'
  },
  harnessDetail: {
    title: 'Autonomous AI Coding Orchestrator',
    intro: 'Vesper Harness is not just a simple pipeline. It seamlessly integrates powerful AI tools like Aider, SWE-agent, and Hermes into a perfect 5-stage (Analyze-Scan-Plan-Execute-Verify) autonomous workflow.',
    box1Title: 'Immersive TUI Dashboard',
    box1Desc: 'Monitor real-time communication logs and progress statuses of multiple background AI agents through a stunning 3-split terminal UI.',
    box2Title: 'Intelligent Self-Healing',
    box2Desc: 'If an error occurs during Playwright-based autonomous testing, it doesn\'t just stop. It analyzes the error logs, generates a fix plan, and intelligently rolls back to the coding stage.',
    downloadBtn: 'NPM (PNPM) Install Guide',
  ...
  home: {
    ...
    harnessTitle: 'Vesper Harness',
    harnessDesc: 'A 5-Stage autonomous coding engine integrating multiple AI agents like Aider, SWE-agent, and Hermes. Orchestrates a perfect pipeline from context analysis to verification.',
    harnessFeatures: ['5-Stage Autonomous Pipeline', 'Dynamic Skill & Auto-Rule Injection', 'Immersive Terminal UI'],
